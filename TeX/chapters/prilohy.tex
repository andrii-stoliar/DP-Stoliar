...
\subsection{Hlavný program pre mikrokontrolér platformy Arduino UNO}
\label{sec:main_cpp_appendix}

\begin{lstlisting}[language=C++, caption={Hlavný program pre mikrokontrolér platformy Arduino UNO}, label={lst:main_cpp_appendix}]
#include <Arduino.h>
...
\subsection{Externý skript pre logovanie dát}
