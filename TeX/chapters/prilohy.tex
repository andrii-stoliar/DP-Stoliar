...
\begin{lstlisting}[style=cppstyle, caption={Hlavný zdrojový kód pre Arduino UNO}, label={lst:main_cpp_appendix}]
#include <Arduino.h>
...
//Here will be initialization of variables and constants, if needed.
...
void loop() {
    ...
    //Here will be whole logic of the control algorithms.
